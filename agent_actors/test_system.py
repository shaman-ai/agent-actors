...
class TestSystem:
    ...
    def test_multi_lookup(self):
        ...
        self.supervisor_agent.run(
            objective="Give me a table of OpenAI founders and their roles and ages."
        )

    def test_thinking(self):
        self.supervisor_agent.set_workers(self.workers + self.workers)
        self.supervisor_agent.run(
            objective="How can we ensure the safe development of AGI? Answer humourously.",
        )
    ...
    def test_strategic_thinking(self):
        ...
        self.supervisor_agent.run(
            objective="Develop a go-to-market plan for a digital agency that provides marketing and web development services for climate fintech companies.",
        )
